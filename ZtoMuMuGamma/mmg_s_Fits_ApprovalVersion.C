...
int main(int argc, char *argv[])
{
	...
	string nomFitMethode = "RooVoigtian2"; //"RooBifurcatedGauss"; //RooVoigtian2
	string PileUpVersion = "2011";
	string LowMmumuLim = "40";
	string HightMmumuLim = "80";
	int FitPourcentage = 92;
	bool phiCracks = true;
	bool etaCracks = true;
	...
	if(isMC == 0)
		...
		if(SurfaceMethod == "Profile_Surface")
		{
			...
			if(date == "16Jan")
				...
				DataChain->Add(Form("/sps/cms/sgandurr/CMSSW_4_2_8_patch7/src/Zmumugamma/%sMiniTrees_June_2012/Data_16Jan_%s/Surface_%s/miniTree_Run2011A-16Jan2012-v1_%s_%s_v3_partALL.root",compressSetOfCorrectionsChain.c_str(),MuonCorrection.c_str(),MZbinning.c_str(),LowMmumuLim.c_str(),HightMmumuLim.c_str()));
				DataChain->Add(Form("/sps/cms/sgandurr/CMSSW_4_2_8_patch7/src/Zmumugamma/%sMiniTrees_June_2012/Data_16Jan_%s/Surface_%s/miniTree_Run2011B-16Jan2012-v1_%s_%s_v3_partALL.root",compressSetOfCorrectionsChain.c_str(),MuonCorrection.c_str(),MZbinning.c_str(),LowMmumuLim.c_str(),HightMmumuLim.c_str()));
...
*/
		...
		if(fitRoo == 1)
		{
			...
			nomFichier = "1overKrecoClassical";
			nomDossierFits = nomDossier;

			if(nomFitMethode == "RooCrystalBall") 
			{
				if(r9sup == 2) nomDossierFits += "Fits/1overKrecoClassicalCBr9All";
				if(r9sup == 1) nomDossierFits += "Fits/1overKrecoClassicalCBr9sup";
				if(r9sup == 0) nomDossierFits += "Fits/1overKrecoClassicalCBr9inf";
			...
			if(nomFitMethode == "RooLogNormal") 
                        {
				if(r9sup == 2) nomDossierFits += "Fits/1overKrecoClassicalLNr9All";
                                if(r9sup == 1) nomDossierFits += "Fits/1overKrecoClassicalLNr9sup";
				if(r9sup == 0) nomDossierFits += "Fits/1overKrecoClassicalLNr9inf";
			...
			if(nomFitMethode == "RooGauss")   
                        {
				if(r9sup == 2) nomDossierFits += "Fits/1overKrecoClassicalGr9All";
                                if(r9sup == 1) nomDossierFits += "Fits/1overKrecoClassicalGr9sup";
				if(r9sup == 0) nomDossierFits += "Fits/1overKrecoClassicalGr9inf";
			...
			if(nomFitMethode == "RooGamma")   
                        {
				if(r9sup == 2) nomDossierFits += "Fits/1overKrecoClassicalGammar9All";
                                if(r9sup == 1) nomDossierFits += "Fits/1overKrecoClassicalGammar9sup";
				if(r9sup == 0) nomDossierFits += "Fits/1overKrecoClassicalGammar9inf";
			...
			if(nomFitMethode == "RooBifurcatedGauss")   
                        {
				if(r9sup == 2) nomDossierFits += "Fits/1overKrecoClassicalBFGr9All";
                                if(r9sup == 1) nomDossierFits += "Fits/1overKrecoClassicalBFGr9sup";
				if(r9sup == 0) nomDossierFits += "Fits/1overKrecoClassicalBFGr9inf";
			...
			if(nomFitMethode == "RooSumGauss")   
                        {
				if(r9sup == 2) nomDossierFits += "Fits/1overKrecoClassicalSumGr9All";
                                if(r9sup == 1) nomDossierFits += "Fits/1overKrecoClassicalSumGr9sup";
				if(r9sup == 0) nomDossierFits += "Fits/1overKrecoClassicalSumGr9inf";
			...
			if(nomFitMethode == "RooGenericPDF")   
                        {
				if(r9sup == 2) nomDossierFits += "Fits/1overKrecoClassicalCBGr9All";
                                if(r9sup == 1) nomDossierFits += "Fits/1overKrecoClassicalCBGr9sup";
				if(r9sup == 0) nomDossierFits += "Fits/1overKrecoClassicalCBGr9inf";
			...
			if(nomFitMethode == "RooLandau2")   
                        {
				if(r9sup == 2) nomDossierFits += "Fits/1overKrecoClassicalLandaur9All";
                                if(r9sup == 1) nomDossierFits += "Fits/1overKrecoClassicalLandaur9sup";
                                if(r9sup == 0) nomDossierFits += "Fits/1overKrecoClassicalLandaur9inf";
			...
			if(nomFitMethode == "RooLandauConvGaussian")   
                        {
				if(r9sup == 2) nomDossierFits += "Fits/1overKrecoClassicalLandauConvGausr9All";
                                if(r9sup == 1) nomDossierFits += "Fits/1overKrecoClassicalLandauConvGausr9sup";
                                if(r9sup == 0) nomDossierFits += "Fits/1overKrecoClassicalLandauConvGausr9inf";
			...
			{
				if(r9sup == 2) nomDossierFits += "Fits/1overKrecoClassicalKernelr9All";
                                if(r9sup == 1) nomDossierFits += "Fits/1overKrecoClassicalKernelr9sup";
                                if(r9sup == 0) nomDossierFits += "Fits/1overKrecoClassicalKernelr9inf";
			...
			{
				if(r9sup == 2) nomDossierFits += "Fits/1overKrecoClassicalVoigtianr9All";
                                if(r9sup == 1) nomDossierFits += "Fits/1overKrecoClassicalVoigtianr9sup";
                                if(r9sup == 0) nomDossierFits += "Fits/1overKrecoClassicalVoigtianr9inf";
...
*/
		...
		else
		{
			...
			if(EndCaps == 0) c2->Print(Form("/sps/cms/sgandurr/CMSSW_4_2_3_patch2/src/UserCode/IpnTreeProducer/ComparaisonFits1overKrecoClassicalJan/Var/Fits/1overKrecoClassicalEB/1overKrecoClassical%d.png",j));
                	if(EndCaps == 0) c2->Print(Form("/sps/cms/sgandurr/CMSSW_4_2_3_patch2/src/UserCode/IpnTreeProducer/ComparaisonFits1overKrecoClassicalJan/Var/Fits/1overKrecoClassicalEB/1overKrecoClassical%d.ps",j));
                	if(EndCaps == 0) c2->Print(Form("/sps/cms/sgandurr/CMSSW_4_2_3_patch2/src/UserCode/IpnTreeProducer/ComparaisonFits1overKrecoClassicalJan/Var/Fits/1overKrecoClassicalEB/1overKrecoClassical%d.pdf",j));
                	if(EndCaps == 0) c2->Print(Form("/sps/cms/sgandurr/CMSSW_4_2_3_patch2/src/UserCode/IpnTreeProducer/ComparaisonFits1overKrecoClassicalJan/Var/Fits/1overKrecoClassicalEB/1overKrecoClassical%d.gif",j));
                	if(EndCaps == 0) c2->Print(Form("/sps/cms/sgandurr/CMSSW_4_2_3_patch2/src/UserCode/IpnTreeProducer/ComparaisonFits1overKrecoClassicalJan/Var/Fits/1overKrecoClassicalEB/1overKrecoClassical%d.C",j));

               		if(EndCaps == 1) c2->Print(Form("/sps/cms/sgandurr/CMSSW_4_2_3_patch2/src/UserCode/IpnTreeProducer/ComparaisonFits1overKrecoClassicalJan/Var/Fits/1overKrecoClassicalEE/1overKrecoClassical%d.png",j));
			if(EndCaps == 1) c2->Print(Form("/sps/cms/sgandurr/CMSSW_4_2_3_patch2/src/UserCode/IpnTreeProducer/ComparaisonFits1overKrecoClassicalJan/Var/Fits/1overKrecoClassicalEE/1overKrecoClassical%d.ps",j));
			if(EndCaps == 1) c2->Print(Form("/sps/cms/sgandurr/CMSSW_4_2_3_patch2/src/UserCode/IpnTreeProducer/ComparaisonFits1overKrecoClassicalJan/Var/Fits/1overKrecoClassicalEE/1overKrecoClassical%d.pdf",j));
			if(EndCaps == 1) c2->Print(Form("/sps/cms/sgandurr/CMSSW_4_2_3_patch2/src/UserCode/IpnTreeProducer/ComparaisonFits1overKrecoClassicalJan/Var/Fits/1overKrecoClassicalEE/1overKrecoClassical%d.gif",j));
               		if(EndCaps == 1) c2->Print(Form("/sps/cms/sgandurr/CMSSW_4_2_3_patch2/src/UserCode/IpnTreeProducer/ComparaisonFits1overKrecoClassicalJan/Var/Fits/1overKrecoClassicalEE/1overKrecoClassical%d.C",j));
...
//Graphe E_{RAW*Ceta*PtCor}/E_{TRUE} Converted (MC) vs Var MC 2gammas
	...
	if(r9sup == 2)
        {
                if(nomFitMethode == "RooCrystalBall") nomDossierTGraph += "TGraph/1overKrecoClassicalCBr9All";
                if(nomFitMethode == "RooLogNormal") nomDossierTGraph += "TGraph/1overKrecoClassicalLNr9All";
                if(nomFitMethode == "RooGauss") nomDossierTGraph += "TGraph/1overKrecoClassicalGr9All";
                if(nomFitMethode == "RooGamma") nomDossierTGraph += "TGraph/1overKrecoClassicalGammar9All";
                if(nomFitMethode == "RooBifurcatedGauss") nomDossierTGraph += "TGraph/1overKrecoClassicalBFGr9All";
                if(nomFitMethode == "RooSumGauss") nomDossierTGraph += "TGraph/1overKrecoClassicalSumGr9All";
                if(nomFitMethode == "RooGenericPDF") nomDossierTGraph += "TGraph/1overKrecoClassicalCBGr9All";
                if(nomFitMethode == "RooLandau2") nomDossierTGraph += "TGraph/1overKrecoClassicalRooLandaur9All";
                if(nomFitMethode == "RooLandauConvGaussian") nomDossierTGraph += "TGraph/1overKrecoClassicalLandauConvGausr9All";
        	if(nomFitMethode == "RooKernel") nomDossierTGraph += "TGraph/1overKrecoClassicalKernelr9All";
		if(nomFitMethode == "RooVoigtian2") nomDossierTGraph += "TGraph/1overKrecoClassicalVoigtianr9All";
	}

	if(r9sup == 1)
	{
		if(nomFitMethode == "RooCrystalBall") nomDossierTGraph += "TGraph/1overKrecoClassicalCBr9sup";
		if(nomFitMethode == "RooLogNormal") nomDossierTGraph += "TGraph/1overKrecoClassicalLNr9sup";
		if(nomFitMethode == "RooGauss") nomDossierTGraph += "TGraph/1overKrecoClassicalGr9sup";
		if(nomFitMethode == "RooGamma") nomDossierTGraph += "TGraph/1overKrecoClassicalGammar9sup";
		if(nomFitMethode == "RooBifurcatedGauss") nomDossierTGraph += "TGraph/1overKrecoClassicalBFGr9sup";
		if(nomFitMethode == "RooSumGauss") nomDossierTGraph += "TGraph/1overKrecoClassicalSumGr9sup";
		if(nomFitMethode == "RooGenericPDF") nomDossierTGraph += "TGraph/1overKrecoClassicalCBGr9sup";
		if(nomFitMethode == "RooLandau2") nomDossierTGraph += "TGraph/1overKrecoClassicalRooLandaur9sup";
		if(nomFitMethode == "RooLandauConvGaussian") nomDossierTGraph += "TGraph/1overKrecoClassicalLandauConvGausr9sup";	
		if(nomFitMethode == "RooKernel") nomDossierTGraph += "TGraph/1overKrecoClassicalKernelr9sup";
		if(nomFitMethode == "RooVoigtian2") nomDossierTGraph += "TGraph/1overKrecoClassicalVoigtianr9sup";
	}

	if(r9sup == 0)
        {
                if(nomFitMethode == "RooCrystalBall") nomDossierTGraph += "TGraph/1overKrecoClassicalCBr9inf";
                if(nomFitMethode == "RooLogNormal") nomDossierTGraph += "TGraph/1overKrecoClassicalLNr9inf";
                if(nomFitMethode == "RooGauss") nomDossierTGraph += "TGraph/1overKrecoClassicalGr9inf";
                if(nomFitMethode == "RooGamma") nomDossierTGraph += "TGraph/1overKrecoClassicalGammar9inf";
                if(nomFitMethode == "RooBifurcatedGauss") nomDossierTGraph += "TGraph/1overKrecoClassicalBFGr9inf";
                if(nomFitMethode == "RooSumGauss") nomDossierTGraph += "TGraph/1overKrecoClassicalSumGr9inf";
                if(nomFitMethode == "RooGenericPDF") nomDossierTGraph += "TGraph/1overKrecoClassicalCBGr9inf";  
		if(nomFitMethode == "RooLandau2") nomDossierTGraph += "TGraph/1overKrecoClassicalRooLandaur9inf";
                if(nomFitMethode == "RooLandauConvGaussian") nomDossierTGraph += "TGraph/1overKrecoClassicalLandauConvGausr9inf";   
        	if(nomFitMethode == "RooKernel") nomDossierTGraph += "TGraph/1overKrecoClassicalKernelr9inf";
		if(nomFitMethode == "RooVoigtian2") nomDossierTGraph += "TGraph/1overKrecoClassicalVoigtianr9inf";
	}	
...
*/	
	...
	nomFichier = "1overKrecoClassicalVsVar";
...
/*	
        if(EndCaps == 0) 
	{	
		c1->Print("/sps/cms/sgandurr/CMSSW_4_2_3_patch2/src/UserCode/IpnTreeProducer/ComparaisonFits1overKrecoClassicalJan/Var/TGraph/1overKrecoClassicalEB/1overKrecoClassicalVsVar.png");
        	c1->Print("/sps/cms/sgandurr/CMSSW_4_2_3_patch2/src/UserCode/IpnTreeProducer/ComparaisonFits1overKrecoClassicalJan/Var/TGraph/1overKrecoClassicalEB/1overKrecoClassicalVsVar.ps");
        	c1->Print("/sps/cms/sgandurr/CMSSW_4_2_3_patch2/src/UserCode/IpnTreeProducer/ComparaisonFits1overKrecoClassicalJan/Var/TGraph/1overKrecoClassicalEB/1overKrecoClassicalVsVar.pdf");
        	c1->Print("/sps/cms/sgandurr/CMSSW_4_2_3_patch2/src/UserCode/IpnTreeProducer/ComparaisonFits1overKrecoClassicalJan/Var/TGraph/1overKrecoClassicalEB/1overKrecoClassicalVsVar.gif");
		c1->Print("/sps/cms/sgandurr/CMSSW_4_2_3_patch2/src/UserCode/IpnTreeProducer/ComparaisonFits1overKrecoClassicalJan/Var/TGraph/1overKrecoClassicalEB/1overKrecoClassicalVsVar.C");
	}

	if(EndCaps == 1) 
        {       
                c1->Print("/sps/cms/sgandurr/CMSSW_4_2_3_patch2/src/UserCode/IpnTreeProducer/ComparaisonFits1overKrecoClassicalJan/Var/TGraph/1overKrecoClassicalEE/1overKrecoClassicalVsVar.png");
                c1->Print("/sps/cms/sgandurr/CMSSW_4_2_3_patch2/src/UserCode/IpnTreeProducer/ComparaisonFits1overKrecoClassicalJan/Var/TGraph/1overKrecoClassicalEE/1overKrecoClassicalVsVar.ps");
                c1->Print("/sps/cms/sgandurr/CMSSW_4_2_3_patch2/src/UserCode/IpnTreeProducer/ComparaisonFits1overKrecoClassicalJan/Var/TGraph/1overKrecoClassicalEE/1overKrecoClassicalVsVar.pdf");
                c1->Print("/sps/cms/sgandurr/CMSSW_4_2_3_patch2/src/UserCode/IpnTreeProducer/ComparaisonFits1overKrecoClassicalJan/Var/TGraph/1overKrecoClassicalEE/1overKrecoClassicalVsVar.gif");
                c1->Print("/sps/cms/sgandurr/CMSSW_4_2_3_patch2/src/UserCode/IpnTreeProducer/ComparaisonFits1overKrecoClassicalJan/Var/TGraph/1overKrecoClassicalEE/1overKrecoClassicalVsVar.C");
        }
*/	
/*		
	...
	if(EndCaps == 0)
        {
                c1->Print("/sps/cms/sgandurr/CMSSW_4_2_3_patch2/src/UserCode/IpnTreeProducer/ComparaisonFits1overKrecoClassicalJan/Var/TGraph/1overKrecoClassicalEB/1overKrecoClassicalVsVarVarCor.png");
                c1->Print("/sps/cms/sgandurr/CMSSW_4_2_3_patch2/src/UserCode/IpnTreeProducer/ComparaisonFits1overKrecoClassicalJan/Var/TGraph/1overKrecoClassicalEB/1overKrecoClassicalVsVarVarCor.ps");
                c1->Print("/sps/cms/sgandurr/CMSSW_4_2_3_patch2/src/UserCode/IpnTreeProducer/ComparaisonFits1overKrecoClassicalJan/Var/TGraph/1overKrecoClassicalEB/1overKrecoClassicalVsVarVarCor.pdf");
                c1->Print("/sps/cms/sgandurr/CMSSW_4_2_3_patch2/src/UserCode/IpnTreeProducer/ComparaisonFits1overKrecoClassicalJan/Var/TGraph/1overKrecoClassicalEB/1overKrecoClassicalVsVarVarCor.gif");
                c1->Print("/sps/cms/sgandurr/CMSSW_4_2_3_patch2/src/UserCode/IpnTreeProducer/ComparaisonFits1overKrecoClassicalJan/Var/TGraph/1overKrecoClassicalEB/1overKrecoClassicalVsVarVarCor.C");
        }

        if(EndCaps == 1)
        {
                c1->Print("/sps/cms/sgandurr/CMSSW_4_2_3_patch2/src/UserCode/IpnTreeProducer/ComparaisonFits1overKrecoClassicalJan/Var/TGraph/1overKrecoClassicalEE/1overKrecoClassicalVsVarVarCor.png");
                c1->Print("/sps/cms/sgandurr/CMSSW_4_2_3_patch2/src/UserCode/IpnTreeProducer/ComparaisonFits1overKrecoClassicalJan/Var/TGraph/1overKrecoClassicalEE/1overKrecoClassicalVsVarVarCor.ps");
                c1->Print("/sps/cms/sgandurr/CMSSW_4_2_3_patch2/src/UserCode/IpnTreeProducer/ComparaisonFits1overKrecoClassicalJan/Var/TGraph/1overKrecoClassicalEE/1overKrecoClassicalVsVarVarCor.pdf");
                c1->Print("/sps/cms/sgandurr/CMSSW_4_2_3_patch2/src/UserCode/IpnTreeProducer/ComparaisonFits1overKrecoClassicalJan/Var/TGraph/1overKrecoClassicalEE/1overKrecoClassicalVsVarVarCor.gif");
                c1->Print("/sps/cms/sgandurr/CMSSW_4_2_3_patch2/src/UserCode/IpnTreeProducer/ComparaisonFits1overKrecoClassicalJan/Var/TGraph/1overKrecoClassicalEE/1overKrecoClassicalVsVarVarCor.C");
        }	
...
/*
	...
	TH1D * MCth = new TH1D("MCth","test", 10000, xmin1overKrecoClassical, xmax1overKrecoClassical);
        int numBin = 0;
        //double i2 = 0;
        int numBinTrue = 0;
*/
...
/*
	...
	c1->ToggleEventStatus();
        ...
        MCth->GetYaxis()->SetTitle("s_{RECO}");
	...
	if(EndCaps == 0) MCth->GetYaxis()->SetRangeUser(ymin1overKrecoClassical,ymax1overKrecoClassical);//a changer
        if(EndCaps == 1) MCth->GetYaxis()->SetRangeUser(ymin1overKrecoClassical,ymax1overKrecoClassical);//a changer
        if(EndCaps == 2) MCth->GetYaxis()->SetRangeUser(ymin1overKrecoClassical,ymax1overKrecoClassical);

        MCth->GetXaxis()->SetLimits(xmin1overKrecoClassical,xmax1overKrecoClassical);
	...
	nomFichier = "1overKrecoClassicalVsVarTH1";
        enregistrementPlots(nomDossierTGraph, nomFichier, EndCaps, 10000, c1);
*/
/*
	if(EndCaps == 0)
        {
                c1->Print("/sps/cms/sgandurr/CMSSW_4_2_3_patch2/src/UserCode/IpnTreeProducer/ComparaisonFits1overKrecoClassicalJan/Var/TGraph/1overKrecoClassicalEB/1overKrecoClassicalVsVarTH1.png");
                c1->Print("/sps/cms/sgandurr/CMSSW_4_2_3_patch2/src/UserCode/IpnTreeProducer/ComparaisonFits1overKrecoClassicalJan/Var/TGraph/1overKrecoClassicalEB/1overKrecoClassicalVsVarTH1.ps");
                c1->Print("/sps/cms/sgandurr/CMSSW_4_2_3_patch2/src/UserCode/IpnTreeProducer/ComparaisonFits1overKrecoClassicalJan/Var/TGraph/1overKrecoClassicalEB/1overKrecoClassicalVsVarTH1.pdf");
                c1->Print("/sps/cms/sgandurr/CMSSW_4_2_3_patch2/src/UserCode/IpnTreeProducer/ComparaisonFits1overKrecoClassicalJan/Var/TGraph/1overKrecoClassicalEB/1overKrecoClassicalVsVarTH1.gif");
                c1->Print("/sps/cms/sgandurr/CMSSW_4_2_3_patch2/src/UserCode/IpnTreeProducer/ComparaisonFits1overKrecoClassicalJan/Var/TGraph/1overKrecoClassicalEB/1overKrecoClassicalVsVarTH1.C");
        }

        if(EndCaps == 1)
        {
                c1->Print("/sps/cms/sgandurr/CMSSW_4_2_3_patch2/src/UserCode/IpnTreeProducer/ComparaisonFits1overKrecoClassicalJan/Var/TGraph/1overKrecoClassicalEE/1overKrecoClassicalVsVarTH1.png");
                c1->Print("/sps/cms/sgandurr/CMSSW_4_2_3_patch2/src/UserCode/IpnTreeProducer/ComparaisonFits1overKrecoClassicalJan/Var/TGraph/1overKrecoClassicalEE/1overKrecoClassicalVsVarTH1.ps");
                c1->Print("/sps/cms/sgandurr/CMSSW_4_2_3_patch2/src/UserCode/IpnTreeProducer/ComparaisonFits1overKrecoClassicalJan/Var/TGraph/1overKrecoClassicalEE/1overKrecoClassicalVsVarTH1.pdf");
                c1->Print("/sps/cms/sgandurr/CMSSW_4_2_3_patch2/src/UserCode/IpnTreeProducer/ComparaisonFits1overKrecoClassicalJan/Var/TGraph/1overKrecoClassicalEE/1overKrecoClassicalVsVarTH1.gif");
                c1->Print("/sps/cms/sgandurr/CMSSW_4_2_3_patch2/src/UserCode/IpnTreeProducer/ComparaisonFits1overKrecoClassicalJan/Var/TGraph/1overKrecoClassicalEE/1overKrecoClassicalVsVarTH1.C");
        }
*/
//	c1->Clear();
        //c1->Delete();
...
/*
	if(EndCaps == 0)
        {
                c1->Print("/sps/cms/sgandurr/CMSSW_4_2_3_patch2/src/UserCode/IpnTreeProducer/ComparaisonFits1overKrecoClassicalJan/Var/TGraph/1overKrecoClassicalEB/Chi2SigmaLR1overKrecoClassicalVsVar.png");
                c1->Print("/sps/cms/sgandurr/CMSSW_4_2_3_patch2/src/UserCode/IpnTreeProducer/ComparaisonFits1overKrecoClassicalJan/Var/TGraph/1overKrecoClassicalEB/Chi2SigmaLR1overKrecoClassicalVsVar.ps");
                c1->Print("/sps/cms/sgandurr/CMSSW_4_2_3_patch2/src/UserCode/IpnTreeProducer/ComparaisonFits1overKrecoClassicalJan/Var/TGraph/1overKrecoClassicalEB/Chi2SigmaLR1overKrecoClassicalVsVar.pdf");
                c1->Print("/sps/cms/sgandurr/CMSSW_4_2_3_patch2/src/UserCode/IpnTreeProducer/ComparaisonFits1overKrecoClassicalJan/Var/TGraph/1overKrecoClassicalEB/Chi2SigmaLR1overKrecoClassicalVsVar.gif");
        	c1->Print("/sps/cms/sgandurr/CMSSW_4_2_3_patch2/src/UserCode/IpnTreeProducer/ComparaisonFits1overKrecoClassicalJan/Var/TGraph/1overKrecoClassicalEB/Chi2SigmaLR1overKrecoClassicalVsVar.C");
	}

	if(EndCaps == 1)
        {
                c1->Print("/sps/cms/sgandurr/CMSSW_4_2_3_patch2/src/UserCode/IpnTreeProducer/ComparaisonFits1overKrecoClassicalJan/Var/TGraph/1overKrecoClassicalEE/Chi2SigmaLR1overKrecoClassicalVsVar.png");
                c1->Print("/sps/cms/sgandurr/CMSSW_4_2_3_patch2/src/UserCode/IpnTreeProducer/ComparaisonFits1overKrecoClassicalJan/Var/TGraph/1overKrecoClassicalEE/Chi2SigmaLR1overKrecoClassicalVsVar.ps");
                c1->Print("/sps/cms/sgandurr/CMSSW_4_2_3_patch2/src/UserCode/IpnTreeProducer/ComparaisonFits1overKrecoClassicalJan/Var/TGraph/1overKrecoClassicalEE/Chi2SigmaLR1overKrecoClassicalVsVar.pdf");
                c1->Print("/sps/cms/sgandurr/CMSSW_4_2_3_patch2/src/UserCode/IpnTreeProducer/ComparaisonFits1overKrecoClassicalJan/Var/TGraph/1overKrecoClassicalEE/Chi2SigmaLR1overKrecoClassicalVsVar.gif");
                c1->Print("/sps/cms/sgandurr/CMSSW_4_2_3_patch2/src/UserCode/IpnTreeProducer/ComparaisonFits1overKrecoClassicalJan/Var/TGraph/1overKrecoClassicalEE/Chi2SigmaLR1overKrecoClassicalVsVar.C");
        }
*/
	c1->Clear();
        //c1->Delete();
...
/*
	if(EndCaps == 0)
        {
                c1->Print("/sps/cms/sgandurr/CMSSW_4_2_3_patch2/src/UserCode/IpnTreeProducer/ComparaisonFits1overKrecoClassicalJan/Var/TGraph/1overKrecoClassicalEB/SigmaSigmaEffrawCVarOverEtrueVsVar.png");
                c1->Print("/sps/cms/sgandurr/CMSSW_4_2_3_patch2/src/UserCode/IpnTreeProducer/ComparaisonFits1overKrecoClassicalJan/Var/TGraph/1overKrecoClassicalEB/SigmaSigmaEffrawCVarOverEtrueVsVar.ps");
                c1->Print("/sps/cms/sgandurr/CMSSW_4_2_3_patch2/src/UserCode/IpnTreeProducer/ComparaisonFits1overKrecoClassicalJan/Var/TGraph/1overKrecoClassicalEB/SigmaSigmaEffrawCVarOverEtrueVsVar.pdf");
                c1->Print("/sps/cms/sgandurr/CMSSW_4_2_3_patch2/src/UserCode/IpnTreeProducer/ComparaisonFits1overKrecoClassicalJan/Var/TGraph/1overKrecoClassicalEB/SigmaSigmaEffrawCVarOverEtrueVsVar.gif");
        	c1->Print("/sps/cms/sgandurr/CMSSW_4_2_3_patch2/src/UserCode/IpnTreeProducer/ComparaisonFits1overKrecoClassicalJan/Var/TGraph/1overKrecoClassicalEB/SigmaSigmaEffrawCVarOverEtrueVsVar.C");
	}

	if(EndCaps == 1)
        {
                c1->Print("/sps/cms/sgandurr/CMSSW_4_2_3_patch2/src/UserCode/IpnTreeProducer/ComparaisonFits1overKrecoClassicalJan/Var/TGraph/1overKrecoClassicalEE/SigmaSigmaEffrawCVarOverEtrueVsVar.png");
                c1->Print("/sps/cms/sgandurr/CMSSW_4_2_3_patch2/src/UserCode/IpnTreeProducer/ComparaisonFits1overKrecoClassicalJan/Var/TGraph/1overKrecoClassicalEE/SigmaSigmaEffrawCVarOverEtrueVsVar.ps");
                c1->Print("/sps/cms/sgandurr/CMSSW_4_2_3_patch2/src/UserCode/IpnTreeProducer/ComparaisonFits1overKrecoClassicalJan/Var/TGraph/1overKrecoClassicalEE/SigmaSigmaEffrawCVarOverEtrueVsVar.pdf");
                c1->Print("/sps/cms/sgandurr/CMSSW_4_2_3_patch2/src/UserCode/IpnTreeProducer/ComparaisonFits1overKrecoClassicalJan/Var/TGraph/1overKrecoClassicalEE/SigmaSigmaEffrawCVarOverEtrueVsVar.gif");
                c1->Print("/sps/cms/sgandurr/CMSSW_4_2_3_patch2/src/UserCode/IpnTreeProducer/ComparaisonFits1overKrecoClassicalJan/Var/TGraph/1overKrecoClassicalEE/SigmaSigmaEffrawCVarOverEtrueVsVar.C");
        }
*/
	c1->Clear();
        //c1->Delete();
...
/*
	...
	if(EndCaps == 0)
        {
                c1->Print("/sps/cms/sgandurr/CMSSW_4_2_3_patch2/src/UserCode/IpnTreeProducer/ComparaisonFits1overKrecoClassicalJan/Var/TGraph/1overKrecoClassicalEB/SigmaEffSCrawCetaOverEtrueVsVarTg.png");
                c1->Print("/sps/cms/sgandurr/CMSSW_4_2_3_patch2/src/UserCode/IpnTreeProducer/ComparaisonFits1overKrecoClassicalJan/Var/TGraph/1overKrecoClassicalEB/SigmaEffSCrawCetaOverEtrueVsVarTg.ps");
                c1->Print("/sps/cms/sgandurr/CMSSW_4_2_3_patch2/src/UserCode/IpnTreeProducer/ComparaisonFits1overKrecoClassicalJan/Var/TGraph/1overKrecoClassicalEB/SigmaEffSCrawCetaOverEtrueVsVarTg.pdf");
                c1->Print("/sps/cms/sgandurr/CMSSW_4_2_3_patch2/src/UserCode/IpnTreeProducer/ComparaisonFits1overKrecoClassicalJan/Var/TGraph/1overKrecoClassicalEB/SigmaEffSCrawCetaOverEtrueVsVarTg.gif");
                c1->Print("/sps/cms/sgandurr/CMSSW_4_2_3_patch2/src/UserCode/IpnTreeProducer/ComparaisonFits1overKrecoClassicalJan/Var/TGraph/1overKrecoClassicalEB/SigmaEffSCrawCetaOverEtrueVsVarTg.C");
        }

        if(EndCaps == 1)
        {
                c1->Print("/sps/cms/sgandurr/CMSSW_4_2_3_patch2/src/UserCode/IpnTreeProducer/ComparaisonFits1overKrecoClassicalJan/Var/TGraph/1overKrecoClassicalEE/SigmaEffSCrawCetaOverEtrueVsVarTg.png");
                c1->Print("/sps/cms/sgandurr/CMSSW_4_2_3_patch2/src/UserCode/IpnTreeProducer/ComparaisonFits1overKrecoClassicalJan/Var/TGraph/1overKrecoClassicalEE/SigmaEffSCrawCetaOverEtrueVsVarTg.ps");
                c1->Print("/sps/cms/sgandurr/CMSSW_4_2_3_patch2/src/UserCode/IpnTreeProducer/ComparaisonFits1overKrecoClassicalJan/Var/TGraph/1overKrecoClassicalEE/SigmaEffSCrawCetaOverEtrueVsVarTg.pdf");
                c1->Print("/sps/cms/sgandurr/CMSSW_4_2_3_patch2/src/UserCode/IpnTreeProducer/ComparaisonFits1overKrecoClassicalJan/Var/TGraph/1overKrecoClassicalEE/SigmaEffSCrawCetaOverEtrueVsVarTg.gif");
                c1->Print("/sps/cms/sgandurr/CMSSW_4_2_3_patch2/src/UserCode/IpnTreeProducer/ComparaisonFits1overKrecoClassicalJan/Var/TGraph/1overKrecoClassicalEE/SigmaEffSCrawCetaOverEtrueVsVarTg.C");
        }
