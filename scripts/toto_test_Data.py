...
process.GlobalTag.globaltag = cms.string('FT_R_42_V24::All')
...
process.totoana = cms.EDAnalyzer("TotoAnalyzer",
   myConfig = cms.PSet(
      ...
      RootFileName = cms.untracked.string('Run2011A-16Jan2012-v1.root'),
...
#      signalGenerator = cms.untracked.string('MADGRAPH'),
      ...
      photonEnergyRegressionFile = cms.untracked.string('gbrv2ph.root'),
...
process.load('ZToMMGHLT_DATA_cff')
